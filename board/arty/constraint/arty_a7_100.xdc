...
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { sd_sclk }]; #IO_L6P_T0_15 Sch=ja[4]
...
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { sd_detect }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
